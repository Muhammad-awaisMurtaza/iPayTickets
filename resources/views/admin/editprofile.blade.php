									...
									<div class="card-body p-4 bg-primary text-white">
										<form>
											<div class="row text-center">
												<div class="col-12">
													<span class="avatar brround avatar-xl" style="background-image: url({{URL::asset('assets/images/faces/male/16.jpg')}})"></span>
												</div>
												<div class="col-12">
												...
												<div class="row">
													<div class="col-12 col-sm-auto mb-3">
														<div class="mx-auto img-2">
															<img src="{{URL::asset('assets/images/faces/male/16.jpg')}}" alt="" >
														</div>
													</div>
