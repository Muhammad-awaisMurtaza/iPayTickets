...
@section('page-header')
						<div class="page-header">
							...
							<ol class="breadcrumb">
								...
								<li class="breadcrumb-item active" aria-current="page">Pricing cards</li>
							</ol>
						</div>
@endsection
@section('content')
									...
									<div class="pricing-divider text-center">
										...
										<svg class='pricing-divider-img' enable-background='new 0 0 300 100' height='100px' id='Layer_1' preserveAspectRatio='none' version='1.1' viewBox='0 0 300 100' width='300px' x='0px' xml:space='preserve' xmlns:xlink='http://www.w3.org/1999/xlink' xmlns='http://www.w3.org/2000/svg' y='0px'>
											<path class='deco-layer deco-layer--1' d='M30.913,43.944c0,0,42.911-34.464,87.51-14.191c77.31,35.14,113.304-1.952,146.638-4.729
												c48.654-4.056,69.94,16.218,69.94,16.218v54.396H30.913V43.944z' fill='#42364e' opacity='0.6'></path>
											<path class='deco-layer deco-layer--2' d='M-35.667,44.628c0,0,42.91-34.463,87.51-14.191c77.31,35.141,113.304-1.952,146.639-4.729
												c48.653-4.055,69.939,16.218,69.939,16.218v54.396H-35.667V44.628z' fill='#42364e' opacity='0.6'></path>
											<path class='deco-layer deco-layer--3' d='M43.415,98.342c0,0,48.283-68.927,109.133-68.927c65.886,0,97.983,67.914,97.983,67.914v3.716
												H42.401L43.415,98.342z' fill='#42364e' opacity='0.7'></path>
											<path class='deco-layer deco-layer--4' d='M-34.667,62.998c0,0,56-45.667,120.316-27.839C167.484,57.842,197,41.332,232.286,30.428
											c53.07-16.399,104.047,36.903,104.047,36.903l1.333,36.667l-372-2.954L-34.667,62.998z' fill='#42364e'></path>
										</svg>
									</div>
                            ...
                            <div class="col-lg-3 col-xs-6 col-sm-6  secondary">
							    <div class="princing-item mb-4">
									...
									<div class=" br-br-7 br-bl-7 bg-white mt-0 shadow text-center">
										...
										<div class="card-footer">
											<button type="button" class="btn btn-secondary btn-block">Sign up for free</button>
										</div>
									</div>
								</div>
							</div>
							...
							<div class="col-lg-3 col-xs-6 col-sm-6 info">
							    <div class="princing-item mb-4">
									...
									<div class=" br-br-7 br-bl-7 bg-white mt-0 shadow text-center">
										...
										<div class="card-footer">
										<button type="button" class="btn btn-info btn-block">Sign up for free</button></div>
									</div>
								</div>
							</div>
						...
						<h4 class="card-title mt-4">Pricing cards 3 colums</h4>
						<div class="row">
							<div class="col-lg-4 col-xs-12  col-sm-12 primary">
							    <div class="princing-item mb-4">
									<div class="pricing-divider text-center">
										<h3 class="text-light">Basic</h3>
										<h4 class="my-0 display-2 text-light font-weight-normal mb-3"><span class="h3">$</span> 120 <span class="h5">/mo</span></h4>
                            ...
                            <div class="col-lg-4 col-xs-12 col-sm-12 secondary">
							    <div class="princing-item mb-4">
									<div class="pricing-divider text-center">
										<h3 class="text-light">Premium</h3>
										<h4 class="my-0 display-2 text-light font-weight-normal mb-3"><span class="h3">$</span> 150 <span class="h5">/mo</span></h4>
							...
							<div class="col-lg-4 col-xs-12 col-sm-12 info">
							    <div class="princing-item mb-4">
									<div class="pricing-divider text-center">
										<h3 class="text-light">Enterprise</h3>
										<h4 class="my-0 display-2 text-light font-weight-normal mb-3"><span class="h3">$</span> 180 <span class="h5">/mo</span></h4>
									...
									<div class=" br-br-7 br-bl-7 bg-white mt-0 shadow text-center">
										...
										<div class="card-footer">
											<button type="button" class="btn btn-info btn-block">Sign up for free</button>
										</div>
									</div>
								</div>
							</div>
						...
						<div class="row">
							...
							<div class="col-xs-12  col-sm-12  col-lg-4">
								<div class="panel price  panel-color">
									...
									<div class="panel-body br-br-7 br-bl-7 text-center">
										<p class="lead"><strong>$35 /</strong>  month</p>
									</div>
									<ul class="list-group list-group-flush text-center">
										<li class="list-group-item"><strong> 4 Free</strong> Domain Name</li>
									...
									<div class=" panel-footer text-center">
										<a class="btn btn-lg btn-primary border-bottom-0" href="#">Purchase Now!</a>
									</div>
								</div>
							</div>
						</div>
						...
						<div class="row">
							...
							<div class="col-sm-6 col-lg-3">
								<div class="card">
									<div class="card-body text-center pricing bg-info">
						...
						<h4 class="card-title mt-4">3 Column pricing table</h4>
						<div class="row">
