							...
							<div class="col-lg-3 col-md-12 col-sm-12">
								<div class="card">
									<div class="list-group list-group-transparent mb-0 mail-inbox">
										...
										<a href="{{ url('/' . $page='emailservices') }}" class="list-group-item list-group-item-action d-flex align-items-center active">
								...
								<div class="card">
                                    ...
                                    <ul class="mail-chats">
                                        <li class="chat-persons">
                                            <a href="#">
                                                <span class="pro-pic"><img src="{{URL::asset('assets/images/faces/male/41.jpg')}}" alt=""></span>
                                                <div class="user">
                                        ...
                                        <li class="chat-persons">
                                            <a href="#">
                                                <span class="pro-pic"><img src="{{URL::asset('assets/images/faces/female/1.jpg')}}" alt=""></span>
                                                <div class="user">
                                        ...
                                        <li class="chat-persons">
                                            <a href="#">
                                                <span class="pro-pic"><img src="{{URL::asset('assets/images/faces/male/35.jpg')}}" alt=""></span>
                                                <div class="user">
                                        ...
                                        <li class="chat-persons">
                                            <a href="#">
                                                <span class="pro-pic"><img src="{{URL::asset('assets/images/faces/female/2.jpg')}}" alt=""></span>
                                                <div class="user">
