...
<!-- Date Picker Plugin -->
<link href="{{URL::asset('assets/plugins/date-picker/spectrum-dark.css')}}" rel="stylesheet" />
<!-- file Uploads -->
<link href="{{URL::asset('assets/plugins/fileuploads/css/dropify.min-dark.css')}}" rel="stylesheet" type="text/css" />
@endsection
@section('page-header')		
...
@section('content')
							...
							<div class="col-lg-6">
								<form  method="post" class="card">
									...
									<div class="card-body">
										...
										<div class="form-group">
											<label class="form-label">Message <span class="form-label-small ml-3">56/100</span></label>
								...
								<form method="post" class="card">
									...
									<div class=" card-body">
										<div class="row">
											...
											<div class="col-lg-4 col-sm-12">
												<input type="file" class="dropify" data-default-file="{{URL::asset('assets/images/media/media1.jpg')}}" data-height="180"  />
											</div>
											<div class="col-lg-4 col-sm-12">
						...
						<div class="row row-deck">
							...
							<div class="col-lg-6">
								<div class="card">
								 <div class="card-header"><h2 class="card-title">Forgot password</div>
									<div class="card-body">
										<form  method="post">
											<div class="mt-4">
