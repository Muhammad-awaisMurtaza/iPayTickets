                        ...
                        <div class="row row-deck">
							<div class="col-xl-4 col-lg-4 col-md-6">
								<div class="card m-b-20 ">
									<img class="card-img-top img-fluid br-tl-7 br-tr-7" src="{{URL::asset('assets/images/photos/3.jpg')}}" alt="Card image cap">
									<div class="card-header">
											...
											<table class="table card-table  table-hover table-vcenter text-nowrap">
												...
												<tbody>
													<tr>
														<td>
															<div class="d-flex align-items-center">
																<div class="mr-3"><img class="avatar avatar-md brround " src="{{URL::asset('assets/images/faces/female/8.jpg')}}" alt="avatar-img"></div>
																<div >
													...
													<tr>
														<td>
															<div class="d-flex align-items-center">
																<div class="mr-3"><img class="avatar avatar-md brround " src="{{URL::asset('assets/images/faces/male/6.jpg')}}" alt="avatar-img"></div>
																<div >
													...
													<tr>
														<td>
															<div class="d-flex align-items-center">
																<div class="mr-3"><img class="avatar avatar-md brround " src="{{URL::asset('assets/images/faces/female/4.jpg')}}" alt="avatar-img"></div>
																<div >
													...
													<tr>
														<td>
															<div class="d-flex align-items-center">
																<div class="mr-3"><img class="avatar avatar-md brround " src="{{URL::asset('assets/images/faces/male/4.jpg')}}" alt="avatar-img"></div>
																<div >
