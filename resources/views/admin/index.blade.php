						...
						<div class="row row-cards">
							...
							<div class="col-sm-12 col-lg-3 col-md-6">
								<div class="card card-img-holder text-default">
									<div class="row">
										<div class="col-4">
											<div class="card-img-absolute circle-icon bg-secondary align-items-center text-center shadow-secondary"><img src="{{ URL::asset('assets/images/circle.svg')}}" class="card-img-absolute"><i class= "lnr lnr-heart fs-30 text-white mt-4"></i></div>
										</div>
										<div class="col-8">
											<div class="card-body p-4">
								...
								<div class="card">
									...
									<div class="card-body">
										<div class="activity mt-3">
											<img src="{{ URL::asset('assets/images/faces/male/7.jpg')}}" alt="" class="img-activity cover-image">
											...
											<img src="{{ URL::asset('assets/images/faces/female/4.jpg')}}" alt="" class="img-activity">
											<div class="time-activity">
												<div class="item-activity">
											...
											<img src="{{ URL::asset('assets/images/faces/male/8.jpg')}}" alt="" class="img-activity">
											<div class="time-activity">
												<div class="item-activity">
