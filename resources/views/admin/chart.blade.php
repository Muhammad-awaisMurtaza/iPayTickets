...
@section('page-header')		
						<div class="page-header">
							...
							<ol class="breadcrumb">
								...
								<li class="breadcrumb-item active" aria-current="page">Sample Charts</li>
							</ol>
						</div>
@endsection
@section('content')
		...
		<span class="nx">$</span><span class="p">(</span><span class="nb">document</span><span class="p">).</span><span class="nx">ready</span><span class="p">(</span><span class="kd">function</span><span class="p">(){</span>
			...
			<span class="na">data</span><span class="p">:</span> <span class="p">{</span>
				...
				<span class="na">colors</span><span class="p">:</span> <span class="p">{</span>
					<span class="s1">'data1'</span><span class="p">:</span> <span class="nx">adminor</span><span class="p">.</span><span class="nx">colors</span><span class="p">[</span><span class="s2">"orange"</span><span class="p">],</span>
					<span class="s1">'data2'</span><span class="p">:</span> <span class="nx">adminor</span><span class="p">.</span><span class="nx">colors</span><span class="p">[</span><span class="s2">"pink"</span><span class="p">]</span>
					<span class="s1">'data3'</span><span class="p">:</span> <span class="nx">adminor</span><span class="p">.</span><span class="nx">colors</span><span class="p">[</span><span class="s2">"teal"</span><span class="p">]</span>
				<span class="p">},</span>
