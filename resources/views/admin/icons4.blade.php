											...
											<div class="col-sm-12 col-lg-9">
												<div class="icons-list-wrap">
													<ul class="icons-list">
														...
														<li class="icons-list-item"><i class="lnr lnr-pie-chart" data-toggle="tooltip" title="lnr lnr-pie-chart"></i></li>
														<li class="icons-list-item"><i class="lnr lnr-pie-chart-2" data-toggle="tooltip" title="lnr lnr-pie-chart-2"></i></li>
