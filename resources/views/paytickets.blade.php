...
<div class="container">
         ...
         <td> <form action="/action_page.php">
            <div class="form-check">
              <label class="form-check-label" for="check1">
                  <input type="checkbox" class="form-check-input" id="check1" name="option1" value="something" <?php if($ticket == $item['ticketNumber']){ echo "checked";} ?>>Pay It
                </label>
            </td>
            </tr>
  ...
  <div class="container">
    <table class="table table-bordered text-center col-lg-12">
      <thead class="bg-dark text-white">
        <tr>
          <th id="selected"> You have selected 2 tickets to pay with total amount of: $300 </th>
